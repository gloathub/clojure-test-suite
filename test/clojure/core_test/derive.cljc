  ...
  (deftest test-derive
    ...
    (testing "derive tag parent"
      (are [tag parent] (let [success (and (nil? (derive tag parent))
                        ...
                        ::rect ::shape
                        'n/a 'n/b
                        #?(:cljs js/String :lpy python/str :glj go/string :default String) ::object))
    ...
    (testing "derive h tag parent"
      (are [expected h tag parent] (= expected (derive h tag parent))
                                   ...
                                   {:ancestors   {#?(:cljs js/String :lpy python/str :glj go/string :default String) #{::object}}
                                    :descendants {::object #{#?(:cljs js/String :lpy python/str :glj go/string :default String)}}
                                    :parents     {#?(:cljs js/String :lpy python/str :glj go/string :default String) #{::object}}} (make-hierarchy) #?(:cljs js/String :lpy python/str :glj go/string :default String) ::object
      ...
      #?(:bb      "bb allows non-namespaced parents"        ; https://github.com/babashka/babashka/issues/1890
         :default (testing "non-namespaced parent"
                    (are [tag parent] (p/thrown? (derive tag parent))
                                      ...
                                      'a 'b
                                      'n/a 'b
                                      #?(:cljs js/String :lpy python/str :glj go/string :default String) :b)))

      (testing "more invalid parents"
        (are [tag parent] (p/thrown? (derive tag parent))
                          ::tag #?(:cljs js/String :lpy python/str :glj go/string :default String)
                          ::tag 42
                          ::tag "parent"))
